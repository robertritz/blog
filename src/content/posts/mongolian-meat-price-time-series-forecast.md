...
description: "A deep dive into Mongolia's meat prices, examining the roles of exports, animal losses, inflation, and seasonal patterns in driving record prices."
pubDate: 2019-05-20
heroImage: "/images/meat_prices/forecast.png"
...
I'm not a big fan of time series forecasts. They are generally too general and not accurate enough to truly understand a problem. Both times I tried previously didn't give good results. But it seems that for meat prices it might not be too bad! Or is it?

Back in November 2018, I used [Facebook's Open Source Prophet](https://research.fb.com/prophet-forecasting-at-scale/) library to forecast mutton and beef prices. For reference (and to show the limitations of time series forecasts), here are the forecasts.

...
# Verify SRC config directory contents before build
RUN echo "Listing /app/src/config:" && ls -la /app/src/config
RUN echo "Listing /app/src/config/en:" && ls -la /app/src/config/en
